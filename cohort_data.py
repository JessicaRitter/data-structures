...
def sort_by_cohort(filename):
    ...
    for line in filename:
        ...
        if temp_list[4] == "I":
            ...
            ghosts.append(temp_list[0] + " " + temp_list[1])
        else:
            all_students.append(temp_list[0] + " " + temp_list[1])
            if temp_list[4] == "Fall 2015":
                fall_15.append(temp_list[0] + " " + temp_list[1])
            elif temp_list[4] == "Summer 2016":
                summer_16.append(temp_list[0] + " " + temp_list[1])
            elif temp_list[4] == "Spring 2016":
                spring_16.append(temp_list[0] + " " + temp_list[1])
            elif temp_list[4] == "Winter 2016":
                winter_16.append(temp_list[0] + " " + temp_list[1])
